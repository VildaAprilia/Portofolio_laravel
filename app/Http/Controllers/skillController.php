    ...
    public function update(Request $request)
    {
        if($request->method() == 'POST') {
            $request->validate([
                ...
                '_language.required'=>'Silahkan masukkan Bahasa Pemrogramman yang anda kuasai',
            ...
            return redirect()->route('skill.index')->with('succes','Berhasil melakukan update data skill.');
        }
    }
}
