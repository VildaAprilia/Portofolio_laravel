...
<html lang="en">
    <head>
        ...
        <link href="{{asset('tampilan')}}/css/styles.css" rel="stylesheet" />
        
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/devicons/devicon@v2.15.1/devicon.min.css">
          
    </head>
    <body id="page-top" style="background-color: #f4cc70;">
       <div class="bg-info" style="background-color: #20948b;">
        <!-- Navigation-->
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    ...
                    <div class="social-icons">
                        ...
                        <a class="social-icon" href="{{get_meta_value ('_instagram')}}"><i class="fab fa-facebook-f"></i></a>
                    </div>
                </div>
            </section>
            <hr class="m-0" />
            ...
            <section class="resume-section" id="education">
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        ...
                        <div class="flex-shrink-0"><span class="text-primary">24 Agustus 2021</span></div>
                    </div>
                    @endforeach
        ...
        <!-- Core theme JS-->
        <script src="{{asset('tampilan')}}/js/scripts.js"></script>
    </body>
</html>
