...
@section ('konten')
    <div class="pb-3"><a hreaf=""><a href="{{ route('experience.index') }}" 
    ...
    <form action="{{ route('experience.store') }}" method="POST">
      @csrf
        ...
        <div class="mb-3">
          <label for="info1" class="form-label">Nama Organisasi</label>
          <input type="text" class="form-control form-control-sm" name="info1" 
            id="info1" aria-describedby="helpId" 
            placeholder="Nama Organisasi" value="{{ Session::get('info1') }}">
        </div>
