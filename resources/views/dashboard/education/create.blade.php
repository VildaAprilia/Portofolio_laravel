...
@section ('konten')
    <div class="pb-3"><a hreaf=""><a href="{{ route('education.index') }}" 
    ...
    <form action="{{ route('education.store') }}" method="POST">
      @csrf
        ...
        <div class="mb-3">
          <label for="info2" class="form-label">IPK</label>
        ...
        <div class="mb-3">
          <div class="row">
            ...
            form-control-sm" name="tgl_akhir" 
              placeholder="dd/mm/yyy"
              value="{{ Session::get('tgl_akhir') }}">></div></div>
          </div>
        </div>
